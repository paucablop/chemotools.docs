...
class DModX(_ModelResidualsBase):
    ...
    mean_centered : bool, default=True
        Whether the input data was mean-centered before modeling.
    ...
    transformer_ : Pipeline or None
        Preprocessing steps before the model, if applicable.
    ...
    train_sse_ : float
        The training sum of squared errors (SSE) for the model, normalized by
        degrees of freedom.
    ...
    >>> from chemotools.outlier import DModX
    >>> import numpy as np
